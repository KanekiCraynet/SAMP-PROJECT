...
public OnPlayerConnect(playerid)
{
	...
	if(!dini_txists(file))
	{
		ShowPlayerDialog(playerid, Dialog_Register, DIALOG_STYLE_INPUT, "Registrasi", "Selamat Datang Player Warga baru", "register", "Balal")
	}
	else	
	{
		ShowPlayerDialog(playerid, Dialog_Login, DIALOG_STYLE_PASSWORD, "Login", "Akun Ini sudah terdaftar", "Login", "Batal")
	}
 	return 1;
}
